...
if isMobile then
    ...
    screenGui.Name = "MagentaHubUI"
    screenGui.ResetOnSpawn = false
    screenGui.Parent = playerGui

    -- Use TextButton as main container (acts like a clickable Frame)
    local buttonFrame = Instance.new("TextButton")
    buttonFrame.Name = "MainButton"
    buttonFrame.Size = UDim2.new(0, 120, 0, 120)
    buttonFrame.Position = UDim2.new(0.5, -60, 0.5, -60)
    buttonFrame.BackgroundColor3 = Color3.fromRGB(255, 0, 255)
    buttonFrame.Text = ""
    ...
    -- When entire UI is clicked, simulate G key
    buttonFrame.MouseButton1Click:Connect(function()
        VirtualInputManager:SendKeyEvent(true, Enum.KeyCode.G, false, game)
        VirtualInputManager:SendKeyEvent(false, Enum.KeyCode.G, false, game)
        print("Simulated pressing G")
    end)
else
    print("PC user detected")
end
